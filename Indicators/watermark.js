//@RobinNakamoto
//@version=5
indicator("Watermark", overlay=true, shorttitle="WMK")
...
i_tableYpos = input.string("bottom", "Position", inline = "12", options = ["top", "middle", "bottom"])
i_tableXpos = input.string("right", "", inline = "12", options = ["left", "center", "right"])
...
signature = input.string("", "Custom Text")
